            ...
            <div className="row container border mx-auto p-5 rounded-3">
                ...
                <div className="col-12 text-center login-form-body col-md-6">
                    ...
                    <div className="d-flex w-75  mx-auto justify-content-between">
                        <button className="btn rounded-pill google-sign-btn border  px-4">Google</button>
                    ...
                    <div className=" d-flex m-0 flex-column align-items-center">
                        <div className="w-75 login-form ">
                           ...
                           {userExist ?  <p className="mt-3 fw-bolder d-flex justify-content-evenly"><span className="text-danger">Forget password?</span><span className="text-info"> create an account.</span></p> :  <p className="mt-3 fw-bolder text-primary d-flex justify-content-evenly">Already have an account?</p>}
                        </div>
                    </div>
                </div>
            </div>

            ...
            <div className="row container border mx-auto p-5 rounded-3">
                ...
                <div className="col-12 text-center login-form-body col-md-6">
                    ...
                    <div className="d-flex w-75  mx-auto justify-content-between">
                        <button onClick={googleSignIn} className="btn rounded-pill google-sign-btn border  px-4">Google</button>
                    ...
                    <div className=" d-flex m-0 flex-column align-items-center">
                        <div className="w-75 login-form ">
                            ...
                            {userExist ? <button className="btn border-0 rounded-pill ps-5 w-100 text-white  py-2 mt-3 gradient-btn ">Login </button> : <button className="btn border-0 rounded-pill ps-5 w-100 text-white  py-2 mt-3 gradient-btn ">Register</button>}
